...
switch (_p_en) do {
    ...
    case "IND_G_F" : {
        ...
        btc_type_motorized_armed = btc_type_motorized_armed + ["I_Heli_light_03_F"] - ["CUP_I_Hilux_armored_zu23_NAPA", "CUP_I_Hilux_zu23_NAPA", "CUP_I_Ural_ZU23_NAPA"];
    };
    case "IND_C_F" : {
    ...
    case "CFP_O_WAGNER" : {
        btc_type_motorized = btc_type_motorized + ["I_G_Offroad_01_repair_F", "I_G_Offroad_01_F", "I_G_Quadbike_01_F", "I_G_Van_01_fuel_F", "I_Truck_02_transport_F", "I_Truck_02_covered_F"];
        btc_type_motorized = btc_type_motorized + ["CFP_O_RUARMY_GAZ_Vodnik_2x_PKM_DES_01", 
    ...
    case "CUP_I_NAPA" : { // National party of chernarus
        ...
        btc_type_motorized = btc_type_motorized - [ "CUP_I_Hilux_armored_zu23_NAPA",
                                                    "CUP_I_Hilux_zu23_NAPA",
                                                    "CUP_I_Ural_ZU23_NAPA"];
        btc_type_motorized_armed = btc_type_motorized_armed + ["I_Heli_light_03_F"] - ["CUP_I_Hilux_armored_zu23_NAPA", "CUP_I_Hilux_zu23_NAPA", "CUP_I_Ural_ZU23_NAPA"];
    };
